...
class GithubWebhookControllerTest {
    ...
    void shouldReturnForbiddenWhenSignatureIsInvalid() {
        ...
        verifyNoInteractions(syncCodebaseUseCase);
    }
    ...
    void shouldSyncRepositoryWhenPushToMasterBranch() {
        ...
        verify(syncCodebaseUseCase, times(1)).syncRepositoryRemoval("owner/repo", "src/Old.java");

        // Verify codebase sync for modification is triggered
        verify(syncCodebaseUseCase, times(1)).syncRepository("owner/repo");
    }
}
